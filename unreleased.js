...
var imageUrls = [
"https://mtsl.dk/csgo/images/SpectrumCase.png",
"https://mtsl.dk/csgo/images/SpectrumCase.png",
"https://mtsl.dk/csgo/images/SpectrumCase.png",
"https://mtsl.dk/csgo/images/SpectrumCase.png",
"https://mtsl.dk/csgo/images/SpectrumCase.png"
    ...
    let cheats = {
        global: {
            ...
            'Give Item': () => {    
                ...
                //GUI.className = "scrollable-frame";
                ...
                imageUrls.forEach(function(url) {
                    ...
                    imageContainer.style.width = "185px";
                    imageContainer.style.marginBottom = "10px";
                    imageContainer.style.marginRight = "10px";
                    imageContainer.style.verticalAlign = "top";
                    ...
                    GUI.appendChild(imageContainer);
                });
                document.body.appendChild(GUI);
                
                var style = document.createElement("style");
                style.innerHTML = ".scrollable-frame::-webkit-scrollbar { width: 0; }";
                style.innerHTML += ".scrollable-frame { scrollbar-width: none; }";
